...
<div class="container pb-6 pt-6">
    <?php
       ...
       if(!isset($_SESSION['busqueda_producto']) &&
        empty($_SESSION['busqueda_producto'])){//nos fijamos si viene definida la variable de sesion con isset
    ?>
    <div class="columns">
        <div class="column">
    ...
    <?php
        ...
        $url="index.php?vistas=product_search&page=";
        $registro=5;//aca defini cuantas registros se van a generar por pagina
        $busqueda=$_SESSION['busqueda_producto'];//aca es donde podemos buscar
